...
public class ItemsTable {
	...
	public ItemsTable(String name, double price, int quantity) {
	...
	public ItemsTable(Item item) {
		this.name = new SimpleStringProperty(item.getName());
		s_name = item.getName();
		s_quantity = item.getQuantity();
		quantity = new SimpleStringProperty(Integer.toString(s_quantity));
		price = new SimpleStringProperty(Double.toString(item.getPrice()));
	}
